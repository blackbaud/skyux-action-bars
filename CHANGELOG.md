...
- Fixed the summary action bar component to properly style the correct modal when two modals are on a page but only one has a summary action bar. [#25](https://github.com/blackbaud/skyux-action-bars/pull/25)
